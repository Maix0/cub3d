...
#    Updated: 2024/10/20 14:53:51 by maiboyer         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BUILD_DIR		?=	../build
SRC_DIR			=	src
INCLUDE_DIR		=	include stdme/include stdme/vendor
LIBS_DIR		=	.
GEN_DIR			=	output/src
...
LIBS			=	$(addprefix $(BUILD_DIR)/,$(addsuffix, .a, $(addprefix lib, me mlx)))
