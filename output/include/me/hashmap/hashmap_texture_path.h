...
typedef void (*t_hash_texture_path_fn)(t_hasher *hasher, t_texture *key);
...
typedef bool (*t_eq_texture_path_fn)(t_texture *lhs, t_texture *rhs);
...
t_hashmap_texture_path *hmap_texture_path_new(t_hash_texture_path_fn hash, t_eq_texture_path_fn	cmp, t_free_texture_path_fn free);
...
/// @return A new hashmap
t_hashmap_texture_path *hmap_texture_path_new_with_buckets(t_hash_texture_path_fn hash, t_eq_texture_path_fn cmp, t_free_texture_path_fn free, size_t cap);
...
bool hmap_texture_path_insert(t_hashmap_texture_path *hmap, t_texture key, t_string value);
...
t_entry_texture_path *hmap_texture_path_get_entry(t_hashmap_texture_path *hmap, t_usize hash, t_texture *key, t_entry_texture_path	**prev);
...
t_error hmap_texture_path_iter(t_hashmap_texture_path *self, t_error (*func)(t_usize idx, const t_texture *key, t_string *val, void *ctx), void *ctx);
...
/// @return An error code
t_error hmap_texture_path_clone(t_hashmap_texture_path *self, t_error (*clone)(const t_kv_texture_path *val, void *ctx, t_kv_texture_path *out), void *ctx, t_hashmap_texture_path **out);
