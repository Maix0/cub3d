...
typedef void				(*t_hash_texture_fn)(t_hasher *hasher,
					t_texture *key);
...
t_hashmap_texture			*hmap_texture_new(t_hash_texture_fn hash,
...
bool						hmap_texture_insert(t_hashmap_texture *hmap,
								t_texture key, t_sprite value);
...
/// hashmap
t_sprite					*hmap_texture_get(t_hashmap_texture *hmap,
								t_texture *key);

/// @brief Removes the key-value pair from the hashmap
/// @param hmap The hashmap
/// @param key The key
void						hmap_texture_remove(t_hashmap_texture *hmap,
								t_texture *key);
...
t_error						hmap_texture_iter(t_hashmap_texture *self,
								t_error (*func)(t_usize idx,
									const t_texture *key, t_sprite *val,
									void *ctx), void *ctx);
...
t_error						hmap_texture_clone(t_hashmap_texture *self,
								t_error (*clone)(const t_kv_texture *val,
									void *ctx, t_kv_texture *out), void *ctx,
