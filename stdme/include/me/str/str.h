...
/// @param str the prefix to be checked for
/// @return true if the string does start with the prefix
bool		str_startwith(t_const_str self, t_const_str str);

/// @brief Check if a string end with `str`
/// @param self the string to Check
/// @param str the suffix to be checked for
/// @return true if the string does start with the suffix
bool		str_endwith(t_const_str self, t_const_str str);

/// @brief Check if a string is only containing character defined in charset
/// @param self the string to check
/// @param charset the charset to be checked against
/// @return true in case of self only containing characters in charset
/// @note if self is empy, then it is true, but if the charset/self is NULL,
/// 	then false
